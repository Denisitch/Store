...
import com.denisitch.feedback.controller.payload.NewFavouriteProductPayload;
import com.denisitch.feedback.entity.FavouriteProduct;
import com.denisitch.feedback.service.FavouriteProductsService;
...
public class FavouriteProductsRestController {
    ...
    public Mono<ResponseEntity<FavouriteProduct>> addProductToFavourites(
        ...
        return Mono.zip(authenticationTokenMono, payloadMono)
                .flatMap(tuple -> this.favouriteProductsService.addProductToFavourites(
